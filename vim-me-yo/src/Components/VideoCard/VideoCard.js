...
const VideoCard = (props) => {
  ...
  return (
    <li className={props.classes} key={props.keys}>
      ...
      {!props.toggleC && <button type="checkbox" id="smiley" className="mdl-button mdl-js-button mdl-button--icon">
          <i className="material-icons" id={props.id} onClick={props.favorite}>mood</i>
        </button>}}
      {props.toggleC && <button type="checkbox" id="smiley" className="mdl-button mdl-js-button mdl-button--icon mdl-button--colored">
            <i className="material-icons" id={props.id} onClick={props.favorite}>mood</i>
          </button>}
    </li>
  )
